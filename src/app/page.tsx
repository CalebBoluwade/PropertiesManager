...
import { Building2, BarChart3, Users, Wallet, ArrowRight, CheckCircle2, Loader2 } from "lucide-react";

const FEATURES = [
  { icon: Building2, title: "Portfolio overview", desc: "Track all your properties, units, and occupancy in one place." },
  { icon: Users, title: "Tenant management", desc: "Manage leases, contacts, and renewal timelines effortlessly." },
  { icon: Wallet, title: "Rent & payments", desc: "Log payments, flag overdue rent, and stay on top of cash flow." },
  { icon: BarChart3, title: "Financial reports", desc: "12-month income vs. expense history with per-property breakdowns." },
];
        ...
        <header className="sticky top-0 z-20 border-b border-zinc-100 dark:border-zinc-900 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-sm">
          <div className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold tracking-tight text-zinc-900 dark:text-zinc-50">Holding</span>
            </div>
            <button
          ...
          <section className="max-w-5xl mx-auto px-6 pb-24">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {FEATURES.map(({ icon: Icon, title, desc }) => (
                <div key={title} className="rounded-2xl border border-zinc-100 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 p-5">
